...
void Params::load(std::string fname) {
    ...
    const std::unordered_map<std::string, void(*)(const std::string&, Params*)> ConfMap {
        ...
        { "RED",   [](const std::string& s, Params* t) { t->color.r  = std::stoi(s)); } },
        { "GREEN", [](const std::string& s, Params* t) { t->color.r  = std::stoi(s)); } },
        { "BLUE",  [](const std::string& s, Params* t) { t->color.r  = std::stoi(s)); } },
        { "ALPHA", [](const std::string& s, Params* t) { t->color.r  = std::stoi(s)); } },
